"""Populate Beardmore's ERA5 surface-pressure cache.
...
Run:
    ...
    python -m beardmore.cache_climate                # default hourly cadence
    python -m beardmore.cache_climate --cadence 3    # 3-hourly
    python -m beardmore.cache_climate --overwrite    # refresh existing cube
"""
