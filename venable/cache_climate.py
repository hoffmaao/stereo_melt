"""Populate Venable's ERA5 surface-pressure cache.
...
Run:
    ...
    python -m venable.cache_climate                # default hourly cadence
    python -m venable.cache_climate --cadence 3    # 3-hourly
    python -m venable.cache_climate --overwrite    # refresh existing cube
"""
