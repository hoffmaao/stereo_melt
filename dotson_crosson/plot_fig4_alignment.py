"""Dotson-Crosson Shean 2019 Fig 4 alignment diagnostics (thin driver).
...
Run:
    /home/hoffmaao/miniconda3/envs/stereo_melt/bin/python \
        -m dotson_crosson.plot_fig4_alignment
"""
...
def main() -> None:
    plot_alignment_diagnostics(
        ...
        "Dotson-Crosson pc_align ICP translation + pre/post residual",
    )
