"""Nansen Shean 2019 Fig 4 alignment diagnostics (thin driver).
...
def main() -> None:
    plot_alignment_diagnostics(
        VARIANTS,
        config.NANSEN_AOI_SHP,
        config.FIGURES_DIR / "fig4_alignment.png",
        "Nansen pc_align ICP translation + pre/post residual",
    )
