"""Populate the Dotson + Crosson ERA5 surface-pressure cache.
...
Run:
    ...
    python -m dotson_crosson.cache_climate                # default hourly
    python -m dotson_crosson.cache_climate --cadence 3    # 3-hourly
    python -m dotson_crosson.cache_climate --overwrite    # refresh existing
"""
