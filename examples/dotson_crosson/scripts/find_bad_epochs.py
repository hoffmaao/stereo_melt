"""Score Dotson + Crosson epochs by post-tilt-fit static-control residual + IRLS weight.

Thin wrapper over :mod:`stereo_melt.coregister.tilt_qc`. Run::

    python -m dotson_crosson.scripts.find_bad_epochs
"""
...
def main() -> None:
    tc, _ = load_basin_stack(
        config.PROCESSED_DIR, "dotson_crosson_stack",
