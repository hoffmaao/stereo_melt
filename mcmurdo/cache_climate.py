"""Populate McMurdo's ERA5 surface-pressure cache.
...
Run:
    ...
    python -m mcmurdo.cache_climate                # default hourly cadence
    python -m mcmurdo.cache_climate --cadence 3    # 3-hourly
    python -m mcmurdo.cache_climate --overwrite    # refresh existing cube
"""
