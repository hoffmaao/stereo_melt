"""Populate Pine Island's ERA5 surface-pressure cache.
...
Run:
    ...
    python -m pig.cache_climate                # default hourly cadence
    python -m pig.cache_climate --cadence 3    # 3-hourly
    python -m pig.cache_climate --overwrite    # refresh existing cube
"""
